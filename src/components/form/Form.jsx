...
import IP from '@/utils/dataFecth.js';
import axiosStand from '../../../../public/utils/axios.fetch.js';
import { UserContext } from '../../contexts/userContext.js';
import { ModalContext } from '@/app/contexts/modalContext.js';
import { useRouter } from 'next/navigation.js';
import useAxios from '@/libs/useAxios.jsx';
import { useDispatch } from 'react-redux';
import { setConfigModal, closeModal } from '@/app/store/slices/globalModal.js';
        ...
        <>
            <form className='form' onSubmit={ e => handlerLogin(e) }>
                ...
                <div className="form-itemsContent">
                    <p className="form-p">Iniciar sessión</p>
                    <label className="form-label">
                        <p className="form-label-p.intro">Usuario </p>
                        <div className=''>
                            <input
                                ref={ inputUserRef }
                    ...
                    <label className="form-labe">
                        <p className="form-label-p.intro">Password</p>
                    ...
                    <button className="form-btnSubmit" type="submit">
                        Iniciar sesión
                    </button>
