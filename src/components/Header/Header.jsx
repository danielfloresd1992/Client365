...
export default function Header() {
    ...
    const returnHtmlLogin = () => {
        if (dataSessionState.stateSession === 'loading') {
            ...
            return (
                <div className='header-buttonContain header-main__menu'>
                    <button
                        className='btn-item btn-item__btn-for-head btn-item_cancel-style header-main__userBtn'
                        title='Opciones de usuario'
                    >
                        {dataSessionState?.dataSession?.img ? (
                            <img
                                className='divContentNovelties-pDateImg divContentNovelties-pDateImg__for-header'
                                src={dataSessionState.dataSession.img}
                                alt='avatar'
                        ...
                        {dataSessionState.stateSession === 'authenticated' && dataSessionState?.dataSession ? <span className='header-main__userName'>{`${dataSessionState?.dataSession?.name} ${dataSessionState?.dataSession?.surName}` || ''}</span> : '...'}
